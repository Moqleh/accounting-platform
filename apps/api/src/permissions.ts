export const RolePermissions: Record<string, string[]> = {
  ...
  Sales: ['dashboard.read','sales.read','sales.write','customers.read','customers.write','inventory.read'],
  Purchases: ['dashboard.read','purchases.read','purchases.write','suppliers.read','suppliers.write','inventory.read'],
